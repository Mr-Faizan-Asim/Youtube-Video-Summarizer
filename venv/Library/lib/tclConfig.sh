...
# installed.
TCL_PREFIX='A:/University/Semester 5/AI/Lab/Youtube Video Summarizer/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='A:/University/Semester 5/AI/Lab/Youtube Video Summarizer/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='A:/University/Semester 5/AI/Lab/Youtube Video Summarizer/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IA:/University/Semester 5/AI/Lab/Youtube Video Summarizer/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LA:/University/Semester 5/AI/Lab/Youtube Video Summarizer/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='A:/University/Semester 5/AI/Lab/Youtube Video Summarizer/venv\Library\lib\tclstub86.lib'
